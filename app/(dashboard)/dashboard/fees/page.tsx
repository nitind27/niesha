...
export default function FeesPage() {
  ...
  const handleDelete = async (feeId: string) => {
    ...
    const feeName = fee ? fee.name : "this fee"
    
    if (!confirm(`Are you sure you want to delete ${feeName}? This action cannot be undone.`)) return
    ...
    try {
      ...
      toast({
        variant: "success",
        title: "Fee Deleted",
        description: `${feeName} has been deleted successfully.`,
      })
      refetch()
    } catch (error: any) {
      toast({
        variant: "destructive",
        title: "Delete Failed",
        description: error.response?.data?.error || "Failed to delete fee. Please try again.",
      })
    }
  }
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage fee structures</p>
        </div>
        <div className="flex items-center gap-2">
        ...
        <CardContent className="space-y-4">
          <div className="flex flex-wrap gap-4">
            ...
            <div className="flex-1 min-w-[200px]">
              <Select
                ...
                onValueChange={(value) =>
                  setFilters({ frequency: value === "all" ? undefined : value })
                }
              >
                <SelectTrigger>
            ...
            {(filters.classId || filters.status || filters.frequency) && (
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12 text-muted-foreground">
              No fees found. Try adjusting your filters.
            </div>
          ) : (
            <>
              <div className="rounded-md border">
                <Table>
                  <TableHeader>
                    <TableRow>
                      <SortableHeader field="name">Fee Name</SortableHeader>
                  ...
                  <TableBody>
                    {fees.map((fee) => (
                      <TableRow key={fee.id}>
                        ...
                        <TableCell>{fee.class?.name || "All Classes"}</TableCell>
                        <TableCell>

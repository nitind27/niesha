  ...
  return (
    <div className="space-y-6">
      ...
      {!isLoading && announcements.length === 0 && (
        <div className="text-center py-20 text-muted-foreground">No announcements yet.</div>
      )}
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    {a.priority && (
                      <Badge variant={a.priority === "high" ? "destructive" : "secondary"} className="text-xs flex-shrink-0 capitalize">
                        {a.priority}
                      </Badge>
                    )}
                  </div>
